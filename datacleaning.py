...
raw_data_1  = pd.read_csv('C:\\Users\\ADMIN\\Desktop\\Hoc\\DUT 5\\AI\\csvs\\2000-01.csv')
raw_data_2  = pd.read_csv('C:\\Users\\ADMIN\\Desktop\\Hoc\\DUT 5\\AI\\csvs\\2001-02.csv')
raw_data_3  = pd.read_csv('C:\\Users\\ADMIN\\Desktop\\Hoc\\DUT 5\\AI\\csvs\\2002-03.csv')
raw_data_4  = pd.read_csv('C:\\Users\\ADMIN\\Desktop\\Hoc\\DUT 5\\AI\\csvs\\2003-04.csv')
raw_data_5  = pd.read_csv('C:\\Users\\ADMIN\\Desktop\\Hoc\\DUT 5\\AI\\csvs\\2004-05.csv')
raw_data_6  = pd.read_csv('C:\\Users\\ADMIN\\Desktop\\Hoc\\DUT 5\\AI\\csvs\\2005-06.csv')
raw_data_7  = pd.read_csv('C:\\Users\\ADMIN\\Desktop\\Hoc\\DUT 5\\AI\\csvs\\2006-07.csv')
raw_data_8  = pd.read_csv('C:\\Users\\ADMIN\\Desktop\\Hoc\\DUT 5\\AI\\csvs\\2007-08.csv')
raw_data_9  = pd.read_csv('C:\\Users\\ADMIN\\Desktop\\Hoc\\DUT 5\\AI\\csvs\\2008-09.csv')
raw_data_10 = pd.read_csv('C:\\Users\\ADMIN\\Desktop\\Hoc\\DUT 5\\AI\\csvs\\2009-10.csv')
raw_data_11 = pd.read_csv('C:\\Users\\ADMIN\\Desktop\\Hoc\\DUT 5\\AI\\csvs\\2010-11.csv')
raw_data_12 = pd.read_csv('C:\\Users\\ADMIN\\Desktop\\Hoc\\DUT 5\\AI\\csvs\\2011-12.csv')
raw_data_13 = pd.read_csv('C:\\Users\\ADMIN\\Desktop\\Hoc\\DUT 5\\AI\\csvs\\2012-13.csv')
raw_data_14 = pd.read_csv('C:\\Users\\ADMIN\\Desktop\\Hoc\\DUT 5\\AI\\csvs\\2013-14.csv')
raw_data_15 = pd.read_csv('C:\\Users\\ADMIN\\Desktop\\Hoc\\DUT 5\\AI\\csvs\\2014-15.csv')
raw_data_16 = pd.read_csv('C:\\Users\\ADMIN\\Desktop\\Hoc\\DUT 5\\AI\\csvs\\2015-16.csv')
raw_data_17 = pd.read_csv('C:\\Users\\ADMIN\\Desktop\\Hoc\\DUT 5\\AI\\csvs\\2016-17.csv')
raw_data_18 = pd.read_csv('C:\\Users\\ADMIN\\Desktop\\Hoc\\DUT 5\\AI\\csvs\\2017-18.csv')
raw_data_19 = pd.read_csv('C:\\Users\\ADMIN\\Desktop\\Hoc\\DUT 5\\AI\\csvs\\2018-19.csv')
raw_data_20 = pd.read_csv('C:\\Users\\ADMIN\\Desktop\\Hoc\\DUT 5\\AI\\csvs\\2019-20.csv')
raw_data_21 = pd.read_csv('C:\\Users\\ADMIN\\Desktop\\Hoc\\DUT 5\\AI\\csvs\\2020-21.csv')
...
#Full Time Home Goal, Full Time Away Goal, Full Time Result
...
print('')
print(playing_statistics_1['HTP'].head)
print(playing_statistics_1['ATP'].head)
#%%
#getting last years position as another independant variable 

Standings = pd.read_csv("C:\\Users\\ADMIN\\Desktop\\Hoc\\DUT 5\\AI\\csvs\\EPLStandings.csv")
...
def get_last(playing_stat, Standings, year):
    ...
    for i in range(380):
        ...
        at = playing_stat.iloc[i].AwayTeam
        #print(i)
        #print(ht, Standings.loc[ht][year])
...
playing_stat = pd.concat([playing_statistics_1,
                          ...
                          playing_statistics_21], ignore_index=True)
...
#%%
data_set = playing_stat.to_csv("final_dataset2.csv")
playing_stat_test.to_csv("test2.csv")